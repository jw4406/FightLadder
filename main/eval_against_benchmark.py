...
def main(PLAYER):
    ...
    #finetune_model = ippo_constructor(args, side="right", file="/home/jw4406/FightLadder/main/benchmark_models/right/FSP0.pt")
    ...
    #                                  file="/home/jw4406/FightLadder/main/benchmark_models/right/FSP0.pt")
    #finetune_model = league_constructor(args, "right", state=state_list[0], file = "/home/jw4406/FightLadder/main/"
    #                                                                                   "benchmark_models/right/LEAGUE.pt")
    #finetune_model = psro_constructor(args, "right", state=state_list[0], file="/home/jw4406/FightLadder/main/"
    ...
    data, params, pytorch_variables = load_from_zip_file("/home/jw4406/FightLadder/main/trained_models/ppo_Guile_sa.zip")
