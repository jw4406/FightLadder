...
cd "$WORKDIR"
RUNDIR="$WORKDIR/main/spar_img_unscaled_test_vtoff"
...
CMD=(
  ...
  --num_env_steps 512
  --vtrace_enabled False --vtrace_seq_len 64 --vtrace_c_bar 1.0
  --vtrace_rho_bar 5.0 --vtrace_replay_capacity 15000
  --checkpoint_interval 2500 --training_batch_size 1024
...
echo "=== SHORT SPAR TEST: obs=image, reward_scale=1.0 (UNSCALED), 300k steps ==="
