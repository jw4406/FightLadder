...
export MODEL_FILE=/home/jw4406/codebase/FightLadder/main/minimax_phase0_vtoff_image_ippo_rs1.0_VegaGuileBlanka_dtj_ent05_160M_ck1M/trained_models/tasks/todo/ippo_Ve_GuBl_60000480_steps.task
...
export USE_LR_ANNEALING=False LR_ANNEAL_COEFF=0.9998
export ENT_COEF=0.05 DSTB_ENT_COEF=0.05
export SEED=0 CHECKPOINT_INTERVAL=41667 TOTAL_TIMESTEPS=99999520
export REINIT_EGO=False
export RUN_SUFFIX=VegaGuileBlanka_dtj_ent05_160M_ck1M_cont
