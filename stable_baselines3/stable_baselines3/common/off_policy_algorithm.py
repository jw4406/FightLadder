...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _sample_action(
        ...
        if isinstance(self.action_space, spaces.Box):
            ...
            buffer_dstb_action = unscaled_dstb_action
            action = buffer_action
            dstb_action = buffer_dstb_action
        return action[0], dstb_action[0], buffer_action[0], buffer_dstb_action[0]
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            if hasattr(self, "smart") and self.smart == True:
                ...
                if type(env.action_space) == MultiDiscrete:
                    action = np.hstack([[actions, dstb_actions]])
