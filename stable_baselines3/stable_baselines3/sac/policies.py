...
class Actor(BasePolicy):
    ...
    def get_action_dist_params(self, obs) -> Tuple[th.Tensor, th.Tensor, Dict[str, th.Tensor]]:
        """
    ...
    def action_log_prob(self, obs) -> Tuple[th.Tensor, th.Tensor]:
        mean_actions, log_std, kwargs = self.get_action_dist_params(obs)
...
class SAACPolicy(BasePolicy):
    ...
    def _predict(self, observation, deterministic: bool = False) -> [th.Tensor, th.Tensor]:
        if self.dstb_net_args['d_see_u'] is True:
...
class MLPAACCNNPolicy(SAACPolicy):
    def __init__(
        self,
        observation_space: spaces.Space,
        action_space: spaces.Space,
